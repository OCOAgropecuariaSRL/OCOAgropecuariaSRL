...
export const galleryItems: GalleryItem[] = [
  {
    ...
    crop: 'Te acompañamos durante toda la siembra',
  ...
  },
  {
    id: 'trab-02',
    type: 'image',
    title: 'Te acompañamos desde el primer momento',
    crop: 'Profesionales, seriedad y trabajos de excelente calidad',
    location: 'Freyre',
    hectares: 85,
    period: 'Temporada 2025/26',
    tone: 2,
  ...
  },
  {
    ...
    type: 'image',
    title: 'Pulverización ',
    crop: 'Contamos con la más alta tecnología',
  ...
  },
  {
    id: 'trab-04',
    type: 'image',
    title: 'Relevamiento aéreo',
    crop: 'Monitoreo preciso al nivel de tus necesidades',
    location: 'Devoto',
    hectares: 200,
    period: '',
    tone: 4,
  ...
  },
  {
    ...
    type: 'video',
    title: 'Fumigación',
    crop: 'Fumigacion precisa, sin desperdicios',
    location: 'El Tío',
    hectares: 45,
    period: 'Temporada 2025/26',
    tone: 5,
  ...
  },
  {
    id: 'trab-06',
    type: 'video',
    title: 'Siembra de avena',
    crop: 'Hacemos crecer tu campo. Sembrar para crecer...',
    location: 'San Francisco ',
    hectares: 150,
    period: 'Invierno 2026',
    tone: 6,
...
export const stats: StatItem[] = [
  ...
  { value: '99%', label: 'Precisión de aplicación' },
